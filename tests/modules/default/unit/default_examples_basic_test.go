...
// TestDefaultExamplesBasicStaticAnalysis verifies the basic example passes static analysis
func TestDefaultExamplesBasicStaticAnalysis(t *testing.T) {
	t.Parallel()
...
// TestDefaultExamplesBasicPlan verifies the basic example can be planned
func TestDefaultExamplesBasicPlan(t *testing.T) {
	t.Parallel()
